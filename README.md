...
- <img src="assets/icons/chart-bar.svg" alt="Data" width="21" height="21" style="vertical-align: middle;"> **Rich Information**: Title, file count, file names, language, public status, created date, update date, engagement metrics, and links
...
|---|---:|---|:---:|---|---|---|---|---|---|---|
| My awesome script | 3 | script.py, config.json, README.md | Python | ✓ | 2024-01-10 09:15 EST | 2024-01-15 12:30 EST | [open](https://gist.github.com/...) | 2 | 1 | 5 |
| Quick utility | 1 | utils.js | JavaScript | ✓ | 2024-01-14 14:00 EST | 2024-01-14 15:20 EST | [open](https://gist.github.com/...) | 0 | 0 | 3 |
